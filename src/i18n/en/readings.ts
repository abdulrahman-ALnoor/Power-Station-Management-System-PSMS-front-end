const en_readings = {
  ...
  addModal: {
    ...
    description:
      'Enter the new reading details. Consumption and cost are calculated automatically by the backend.',

    editDescription:
      'Only the most recent reading for a meter can be edited, and only if no invoice is linked to it yet.',
  ...
  errors: {
    loadFailed:
      'Failed to load readings. Make sure the backend server is running.',
