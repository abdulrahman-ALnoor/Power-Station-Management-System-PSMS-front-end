  ...
  return createPortal(
    <div style={{ position: 'fixed', inset: 0, zIndex: 10000 }}>
      ...
      >
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-outline/10 bg-surface-white">
            ...
            <button 
              onClick={onClose}
              className="p-2 rounded-full hover:bg-surface-variant transition-colors text-outline"
            >
              <X size={20} />
            </button>
          </div>

          <div className="p-6 bg-surface-container-lowest flex flex-col items-center justify-center min-h-[300px]">
            {error ? (
              <div className="text-center space-y-4">
                ...
                <button
                  onClick={onClose}
                  className="px-6 py-2.5 rounded-lg border border-outline/20 hover:bg-surface-variant transition-colors"
                >
                  {isRTL ? 'إغلاق' : 'Close'}
                </button>
              </div>
              ...
              <>
                ...
                <p className="mt-6 text-center text-on-surface font-medium">
          ...
          <div className="p-4 border-t border-outline/10 bg-surface-white flex justify-center shrink-0">
            <button
              onClick={onClose}
              className="w-full sm:w-auto px-8 py-2.5 rounded-lg border border-outline/20 hover:bg-surface-variant font-semibold transition-colors"
            >
              {isRTL ? 'إلغاء' : 'Cancel'}
            </button>
          </div>
