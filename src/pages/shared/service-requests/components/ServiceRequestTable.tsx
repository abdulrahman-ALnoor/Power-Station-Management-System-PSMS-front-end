                  ...
                  <div ref={openMenuId === req.id ? menuRef : null} className="relative inline-block text-right">
                    ...
                    {openMenuId === req.id && (
                      ...
                      >
                        <button
                          type="button"
                          className={cn("w-full px-4 py-2 text-sm flex items-center gap-3 hover:bg-surface-container-lowest transition-colors text-text", isRTL ? "text-right" : "text-left")}
                          onClick={() => {
                            setOpenMenuId(null)
                            onViewDetails(req)
                          }}
                        ...
                        {onDelete && (
                          <button
                            type="button"
                            className={cn("w-full px-4 py-2 text-sm flex items-center gap-3 hover:bg-surface-container-lowest transition-colors text-error", isRTL ? "text-right" : "text-left")}
                            onClick={() => {
                              setOpenMenuId(null)
                              onDelete(req)
                            }}
