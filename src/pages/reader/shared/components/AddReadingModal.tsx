...
export function AddReadingModal({ isOpen, onClose, onSuccess }: AddReadingModalProps) {
 ...
 >
 {/* Header */}
 <div className="flex items-center gap-3 mb-6 shrink-0 border-b border-border dark:border-border-subtle pb-4">
 ...
 className={cn(
 "w-full bg-surface-low dark:bg-surface-elevated border border-border dark:border-border-subtle text-text text-sm rounded-lg min-h-[44px] py-2.5 px-4",
 "focus:ring-2 focus:ring-primary/20 focus:border-primary dark:focus:border-info transition-shadow cursor-pointer appearance-none disabled:opacity-50"
 )}
 >
 ...
 className="text-sm font-medium text-text-muted hover:text-danger transition-colors px-3 py-1.5 rounded bg-surface shadow-sm border border-border dark:border-border-subtle"
 >
 تغيير العداد
 </button>
 </div>
 ...
 <div className="bg-surface-container dark:bg-surface-elevated rounded-lg p-3 text-sm border border-transparent dark:border-border-subtle">
 ...
 dir="ltr"
 className="w-full bg-surface-dim dark:bg-surface-elevated/50 border border-border/50 dark:border-border-subtle text-text-muted text-sm rounded-lg min-h-[44px] py-2.5 px-4 text-start cursor-not-allowed"
 />
 </div>
 ...
 dir="ltr"
 className="w-full bg-surface dark:bg-surface-elevated border border-border dark:border-border-subtle text-text text-sm rounded-lg min-h-[44px] py-2.5 px-4 focus:ring-2 focus:ring-primary/20 focus:border-primary dark:focus:border-info transition-shadow text-start"
 />
 </div>
 ...
 className="w-full bg-surface dark:bg-surface-elevated border border-border dark:border-border-subtle text-text text-sm rounded-lg min-h-[44px] py-2.5 px-4 focus:ring-2 focus:ring-primary/20 focus:border-primary dark:focus:border-info transition-shadow cursor-pointer appearance-none"
 >
 ...
 rows={3}
 className="w-full bg-surface dark:bg-surface-elevated border border-border dark:border-border-subtle text-text text-sm rounded-lg py-2.5 px-4 focus:ring-2 focus:ring-primary/20 focus:border-primary dark:focus:border-info transition-shadow resize-none"
 />
 </div>
 </div>
 )}
 ...
 {/* Footer Actions */}
 <div className="pt-6 border-t border-border dark:border-border-subtle flex flex-col sm:flex-row items-center justify-end gap-3 shrink-0">
 <button
 type="button"
 disabled={isSubmitting}
 onClick={onClose}
 className="w-full sm:w-auto px-6 py-2.5 rounded-lg border border-border dark:border-border-subtle text-text font-semibold hover:bg-surface-low dark:hover:bg-surface-hover transition-colors min-h-[44px]"
 >
 إلغاء
 </button>
 <button
