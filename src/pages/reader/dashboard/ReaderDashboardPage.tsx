    ...
    if (this.state.hasError) {
      return (
        <div className="p-8 bg-surface text-center rounded-xl border border-border shadow-sm">
          ...
          <h2 className="text-xl font-bold mb-2 text-text">تعذر تحميل بيانات لوحة التحكم</h2>
          <button 
...
function DashboardContent() {
  ...
  if (loading || !data) {
    return (
      <div className="space-y-6 max-w-[1440px] mx-auto pb-12 animate-pulse" dir="rtl">
