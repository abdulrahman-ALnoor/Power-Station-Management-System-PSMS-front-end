...
export function ReaderEquipmentPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto w-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="font-headline-sm text-headline-sm font-bold text-primary dark:text-white">
            {t('equipment.title')}
          </h1>
      ...
      {/* Drawer */}
      {/* NOTE: onStatusUpdate is intentionally omitted for the Reader role to disable editing capabilities */}
