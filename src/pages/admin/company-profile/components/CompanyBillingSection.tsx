...
export function CompanyBillingSection({ data, onChange }: CompanyBillingSectionProps) {
 ...
 <label htmlFor="currency" className="block text-label-md font-bold text-text-primary ">
 ...
 <div className="space-y-2">
 <label htmlFor="price_per_kwh" className="block text-label-md font-bold text-text-primary ">
 ...
 <label htmlFor="reading_cycle_days" className="block text-label-md font-bold text-text-primary ">
