...
export function EmployeeStats() {
 ...
 if (trend.type === 'up') return 'text-green-600 bg-green-50 '
 if (trend.type === 'down') return 'text-red-500 bg-red-50 '
 return 'text-text-primary-variant bg-surface-container '
 }
 ...
 key={stat.id} 
 className={cn(
 "bg-surface p-5 rounded-xl shadow-sm border-s-4 transition-colors duration-200",
 ...
 <p className="font-label-sm text-label-sm text-text-primary-variant mb-1">
 {t(stat.labelKey)}
 </p>
 <h3 className="font-display-lg text-display-lg font-bold text-primary ">
 {stat.value}
 </h3>
