...
export default function EmployeesPage() {
 ...
 <nav className="flex items-center text-text-primary-variant font-label-sm text-label-sm ms-4">
 ...
 <span className="text-primary font-bold ">{t('breadcrumbs.employees')}</span>
 </nav>
 <h1 className="font-headline-md text-headline-md text-primary font-bold border-s-4 border-bright-gold ps-3 ">
 {t('pageTitle')}
 </h1>
 </div>
