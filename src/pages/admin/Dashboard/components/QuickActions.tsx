...
export function QuickActions({
  ...
  const actions: {
  ...
  }[] = [
    {
      ...
      actionId: 'addCustomer',
    },
    {
      icon: <Zap size={28} />,
      labelKey: 'quickActions.addMeter',
      actionId: 'addMeter',
    },
    {
      icon: <FileEdit size={28} />,
      labelKey: 'quickActions.addReading',
      actionId: 'addReading',
    },
    {
      icon: <ReceiptText size={28} />,
      labelKey: 'quickActions.createInvoice',
      actionId: 'createInvoice',
    },
    {
      icon: <BadgePlus size={28} />,
      labelKey: 'quickActions.addEmployee',
      actionId: 'addEmployee',
    },
    {
      icon: <Wrench size={28} />,
      labelKey: 'quickActions.addEquipment',
      actionId: 'addEquipment',
    },
    {
      icon: <Headset size={28} />,
      labelKey: 'quickActions.requestService',
      actionId: 'requestService',
    },
    {
      icon: <FileText size={28} />,
      labelKey: 'quickActions.viewReports',
      actionId: 'viewReports',
    },
  ]
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {actions.map((action) => (
          ...
          >
            <span className="
              text-primary
              group-hover:text-[var(--color-amber-gold)]
              transition-colors
              duration-300
              flex
              items-center
