...
export function InvoiceCharts() {
 ...
 <div className="lg:col-span-2 bg-surface p-6 rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
 <h3 className="font-headline-md font-bold text-text-primary mb-6">
 ...
 <div className="bg-surface p-6 rounded-xl shadow-[0px_4px_12px_rgba(0,0,0,0.05)]">
 <h3 className="font-headline-md font-bold text-text-primary mb-6">
