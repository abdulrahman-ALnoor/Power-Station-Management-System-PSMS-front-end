        ...
        >
          ...
          >
            ...
            <div className="col-span-2 flex justify-end gap-3 mt-4 pt-6 border-t border-outline-variant dark:border-border-muted">
              ...
              <button 
                type="submit"
                className="px-10 py-2 bg-primary text-on-primary rounded-lg font-bold hover:bg-primary-container dark:bg-primary-fixed dark:text-primary dark:hover:bg-primary dark:hover:text-white transition-colors shadow-md"
              >
                {t('modal.save')}
              </button>
            </div>
