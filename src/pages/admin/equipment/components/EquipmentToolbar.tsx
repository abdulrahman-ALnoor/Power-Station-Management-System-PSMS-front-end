...
export function EquipmentToolbar({ onAddClick }: EquipmentToolbarProps) {
 ...
 <button 
 onClick={onAddClick}
 className="flex items-center gap-2 px-6 py-2 bg-primary text-on-primary rounded-lg font-bold hover:bg-primary-container :bg-primary :text-white transition-colors shadow-md active:scale-95"
 >
 <Plus size={20} />
 ...
 <button 
 className="p-2 border border-border-variant text-text-primary-variant rounded-lg hover:bg-surface-container :bg-surface transition-colors"
