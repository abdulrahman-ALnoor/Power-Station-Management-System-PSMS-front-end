                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative">
                      <Search className="absolute inset-inline-end-3 top-1/2 -translate-y-1/2 text-slate-500 dark:text-slate-400 w-5 h-5 pointer-events-none" />
                      <input
                        type="text"
                        required
                        placeholder={t('modal.searchCustomerPlaceholder')}
                        className="w-full pe-10 ps-4 h-11 bg-white dark:bg-slate-800 rounded-lg border border-slate-300 dark:border-slate-600 focus:ring-2 focus:ring-primary focus:border-transparent outline-none text-slate-900 dark:text-white transition-all"
                      />
                    </div>
                  </div>
                </div>
