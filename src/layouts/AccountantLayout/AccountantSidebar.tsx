// ============================================================
// AccountantSidebar — Dark navy sidebar navigation for Accountant
// ============================================================
...
import { ACCOUNTANT_NAV_GROUPS } from '@/config/navigation'
...
export function AccountantSidebar({ isMobileOpen, onMobileClose }: AccountantSidebarProps) {
    ...
    <>
      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto overflow-x-hidden py-4 px-2">
          {ACCOUNTANT_NAV_GROUPS.map((group, groupIndex) => (
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        cn(
                          ...
                          isActive 
                            ? 'bg-white/10 text-white after:absolute after:inset-block-0 after:inset-inline-start-0 after:w-1 after:rounded-r-full after:bg-[var(--color-sidebar-accent)]'
